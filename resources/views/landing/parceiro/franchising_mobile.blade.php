<section id="franchising">
    <div layout="column" class="custom-bg-white">
        <h1 class="custom-color-green custom-section"><strong>De onde surgiu a <span class="custom-brand-green-small">Vende aí!</span>?</strong>
        </h1><br>

        <div layout="column" class="custom-section">
            <h4 class="custom-color-green" align="justify">Nossa solução está baseada no conceito de dropshipping que é
        ...
        <div class="custom-bg-grice custom-padding-20">
            <div layout="column" class="custom-section">
                <h4 align="justify" class="custom-color-green">Sabemos que um bom time de vendas faz a diferença.
                    Mas imagine o custo para levar seus produtos para todo o Brasil? </h4> <br><br>
            </div>
            ...
            <div layout="column" class="custom-section">
                ...
                <h4 align="justify" class="custom-color-green">E mais, você poderá disponibilizar vídeos e materiais dos
                    seus produtos e marca online gratuitamente
        ...
        <div class="custom-bg-grice custom-padding-20">
            <div layout="column" class="custom-section">
                ...
                <h4 align="justify" class="custom-color-green">
                    Acreditamos na real trasformação que as redes pessoais trazem para os mercados e como as pessoas
                    podem se tornar agentes das marcas. Quem sabe até seus revendedores virtuais não
                    estarão
