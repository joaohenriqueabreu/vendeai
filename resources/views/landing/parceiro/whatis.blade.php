<section id="o-que-e">
    <div class="custom-bg-green custom-super-section" layout="column" layout-align="center center">
        <div layout="row" layout-align="center center">
            ...
            <img class="custom-mini-image" src="{{ asset('img/icons/question2.png') }}"> &nbsp;&nbsp;&nbsp;&nbsp;
        </div>
        ...
        <div layout-gt-sm="row" layout-xs="column" layout-sm="column" layout-align="center center">
            ...
            <div flex-gt-sm="30" layout="column" layout-align="center center">
                <img class="custom-mini-image" src="{{ asset('img/icons/woman (1).png') }}">
                <h3 class="custom-color-white"><strong>os produtos da Gabriela</strong></h3>
                <p class="custom-color-white" align="justify">
                    A Gabriela é dona de uma loja de produtos esportivos.
                    Ela mora em Goiás e gostaria vender seus produtos para todo o Brasil, mas para isso
                    ela precisa de profissionais capacitados, pois não tem tempo para fazer isso sozinha.
                    A Gabi cadastrou seus produtos na
                    <span class="custom-brand-white-small">Vende aí</span> e
                    eles foram escolhidos para diversas lojas como a do Rodrigo.
                </p>
            </div>
            ...
            <div flex-gt-sm="30" layout="column" layout-align="center center">
                ...
                <p class="custom-color-white" align="justify">
                    ...
                    Hoje o Rodrigo ficou craque em marketing digital para promover sua loja que bombou
                    na internet com posts engraçados.
                </p>
            </div>
        </div>
        ...
        <div layout="column" layout-align="center center">
            <img class="custom-mini-image" src="{{ asset('img/icons/solar-system.png') }}">
