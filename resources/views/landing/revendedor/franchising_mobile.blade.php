<div layout="column" class="custom-bg-white">
    ...
    <div class="custom-bg-ice custom-section">
        ...
        <div layout="column">
            <h4 align="justify">Na <span class="custom-brand-small">Vende aí!</span>&nbsp; você leva poucos minutos para montar sua loja e começar seu negócio virtual</h4>
        </div>
    </div>
    ...
    <div layout="column" class="custom-section">
        ...
        <div layout-gt-sm="row" layout-xs="column" layout-sm="column" class="">
            ...
            <div flex layout="column" layout-align="center center">
                <img class="custom-mini-image" src="{{ asset('img/icons/receipt2.png') }}"><br>
