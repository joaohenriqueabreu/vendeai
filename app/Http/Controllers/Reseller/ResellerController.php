...
class ResellerController extends Controller
{
    ...
    {
        $resellers = Reseller::paginate(5);
        $user = Auth::user();

        return view('resellers.index', ['resellers' => $resellers, 'user' => $user]);
    }
    ...
    public function create()
    {
        ...
        return view('resellers.create', ['reseller' => $reseller, 'user' => $user, 'user_id' => Auth::id()]);
    }
    ...
    public function show($id)
    {
        ...
        return view('resellers.show', array('reseller' => $reseller));
    }
    ...
    public function edit($id)
    {
        ...
        return view('resellers.edit', ['reseller' => $reseller, 'user' => $user,  'user_id' => Auth::id()]);
    }
